...
func (d *Database) Load(ctx context.Context, db DB, table string, dst interface{}, pk int64) error {
...
func Load(ctx context.Context, db DB, table string, dst interface{}, pk int64) error {
...
func (d *Database) Insert(ctx context.Context, db DB, table string, src interface{}) error {
...
func Insert(ctx context.Context, db DB, table string, src interface{}) error {
...
func (d *Database) Update(ctx context.Context, db DB, table string, src interface{}) error {
	// gather the query parts
...
func Update(ctx context.Context, db DB, table string, src interface{}) error {
...
func (d *Database) Save(ctx context.Context, db DB, table string, src interface{}) error {
	pkName, pkValue, err := d.PrimaryKey(src)
	if err != nil {
		return err
	}
...
func Save(ctx context.Context, db DB, table string, src interface{}) error {
...
// result row.
func (d *Database) QueryRow(ctx context.Context, db DB, dst interface{}, query string, args ...interface{}) error {
	// perform the query
...
func QueryRow(ctx context.Context, db DB, dst interface{}, query string, args ...interface{}) error {
...
func (d *Database) QueryAll(ctx context.Context, db DB, dst interface{}, query string, args ...interface{}) error {
	// perform the query
	rows, err := db.QueryContext(ctx, query, args...)
	if err != nil {
		return err
...
func QueryAll(ctx context.Context,db DB, dst interface{}, query string, args ...interface{}) error {
